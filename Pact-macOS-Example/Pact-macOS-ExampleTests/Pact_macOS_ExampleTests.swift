//
//  Pact_macOS_ExampleTests.swift
//  Pact-macOS-ExampleTests
//
//  Created by Marko Justinek on 5/5/20.
...
class Pact_macOS_ExampleTests: XCTestCase {

	var mockService = MockService(consumer: "passing-macOS-app", provider: "test-provider")
